...
class GameWidget(QtGui.QWidget):
	...
	def __init__(self, _ao_app):
		...
		oocpalette = QtGui.QPalette()
		oocpalette.setColor(QtGui.QPalette.Base, QtGui.QColor(64,64,64))
		oocpalette.setColor(QtGui.QPalette.Text, QtGui.QColor("white"))
		...
		self.oocchat.setPalette(oocpalette)
		...
		self.oocnameinput.setPalette(oocpalette)
		...
		self.oocinput.setPalette(oocpalette)
